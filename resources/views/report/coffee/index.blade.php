...
<section class="vbox bg-white">
	<section class="scrollable padder">
		...
		<hr>
			{!! Form::open(['method' => 'GET','url'=>array("$baseUrl/report/coffee/export"),'class'=>'form-inline','id'=>'formsdate']) !!}
					...
					<select name="formId" id="selectform" class="form-control" required>
						  ...
						  @foreach ($forms as $form)
						  	@if ($form['rolesCode'] == 'admin' || $form['rolesCode']['questionFormRoleCode'] == '0' || $form['rolesCode']['answerFormRoleCode'] == '2')
						  		@if ($form['objectId'] != '12345' && $form['objectId'] != '123456')
...
$("#formReport").submit(function(event){
	...
	request = $.ajax({
		url: baseUrl + "/report/coffee/download",
		type: "get",
		data: serializedData
	});
